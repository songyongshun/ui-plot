...
function getFunction() {
  ...
  var group_x = document.getElementsById("var_x");
  var group_y = document.getElementsById("var_y");
	var x, y;
	var lax, lay;
	var px, py
	...
	for(var k = 1; k < group_x.length; k++) {

		var _funcItem = group_x[k].parentNode;
		...
		// 函数表达式
		funcExpression = group_x[k].value;
		// 是否画线（默认画点）
